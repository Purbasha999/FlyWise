...
const seed = async () => {
  ...
  const flightsData = [
    ...
    // ---------------- RETURN FLIGHTS (2 DAYS LATER) ----------------
    // Delhi → Mumbai (return for FW101/FW102)
    { flightNumber: 'FW103', airline: 'FlyWise Air', airlineCode: 'FW', source: { city: 'Delhi', code: 'DEL' }, destination: { city: 'Mumbai', code: 'BOM' }, daysOffset: 3, depHour: 9, duration: 120, basePrice: 4600 },
    { flightNumber: 'FW104', airline: 'FlyWise Air', airlineCode: 'FW', source: { city: 'Delhi', code: 'DEL' }, destination: { city: 'Mumbai', code: 'BOM' }, daysOffset: 3, depHour: 18, duration: 125, basePrice: 5300 },
    // Bangalore → Delhi (return for FW201/FW202)
    { flightNumber: 'FW203', airline: 'SkyJet', airlineCode: 'SJ', source: { city: 'Bangalore', code: 'BLR' }, destination: { city: 'Delhi', code: 'DEL' }, daysOffset: 3, depHour: 7, duration: 150, basePrice: 3900 },
    { flightNumber: 'FW204', airline: 'SkyJet', airlineCode: 'SJ', source: { city: 'Bangalore', code: 'BLR' }, destination: { city: 'Delhi', code: 'DEL' }, daysOffset: 3, depHour: 19, duration: 155, basePrice: 4200 },
    // Hyderabad → Chennai (return for FW301)
    { flightNumber: 'FW302', airline: 'IndiaWings', airlineCode: 'IW', source: { city: 'Hyderabad', code: 'HYD' }, destination: { city: 'Chennai', code: 'MAA' }, daysOffset: 4, depHour: 12, duration: 80, basePrice: 2900 },
    // Mumbai → Kolkata (return for FW401)
    { flightNumber: 'FW402', airline: 'AirBharat', airlineCode: 'AB', source: { city: 'Mumbai', code: 'BOM' }, destination: { city: 'Kolkata', code: 'CCU' }, daysOffset: 4, depHour: 10, duration: 160, basePrice: 5600 },
    // Delhi → Goa (return for FW501)
    { flightNumber: 'FW502', airline: 'FlyWise Air', airlineCode: 'FW', source: { city: 'Delhi', code: 'DEL' }, destination: { city: 'Goa', code: 'GOI' }, daysOffset: 5, depHour: 11, duration: 140, basePrice: 6100 },
    // Goa → Mumbai (return for FW601)
    { flightNumber: 'FW602', airline: 'SkyJet', airlineCode: 'SJ', source: { city: 'Goa', code: 'GOI' }, destination: { city: 'Mumbai', code: 'BOM' }, daysOffset: 3, depHour: 13, duration: 75, basePrice: 2600 },
  ];
